            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex space-x-4 mb-4">
                    ...
                    <select
                        ...
                        onChange={handleChange}
                        className="focus:shadow-outline appearance-none border-double border border-red-500 p-2 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    >
