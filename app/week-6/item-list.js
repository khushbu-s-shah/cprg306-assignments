        ...
        <div className="p-4">
            <div className="bg-black flex justify-center mb-6 mx-auto  p-1">
              <label htmlFor='item' className='text-lg text-white mb-4 font-bold p-2 py-2 px-4'>Sort:</label>
                ...
                <button className={`block sm:inline-block md:text-xl m-2 px-4 py-2 rounded-full text-white shadow  ${sortBy === 'group' ? 'bg-gradient-to-tr from-violet-400 to-green-400' : 'bg-green-500'}`}
